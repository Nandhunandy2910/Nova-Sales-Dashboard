...
Focused on four models: MDX, INTEGRA, AURORA, and HYDRA.

Designed to provide real-time sales, deal size, and regional insights.
...
CSV Dataset – acura_mdx_sales_sample.csv

Custom Visuals – Cards, Maps, Donut & Bar Charts
